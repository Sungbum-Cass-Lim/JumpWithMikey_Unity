...
public class WebNetworkMgr : SingletonComponentBase<WebNetworkMgr>
{
    ...
    public void InitNetwork(Action<bool> RequestTokenCallBack)
    {
        ...
        //카스
        string tempData = "{ \"uid\": 2, \"tid\": 2, \"gameId\": \"yokaiwatch\", \"token\": \"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjEsInRvdXJuYW1lbnRVaWQiOjEsImdhbWVJZCI6InNwb29reWJvbWIifQ._1h1Q1-tObbwrxmzhyer6QLN_4hi-V62EKRHsWnrU4Q\"}";
